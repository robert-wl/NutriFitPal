      ...
      <ImageDescription
        ...
        <div className="flex flex-col justify-center items-start w-1/2 gap-2">
          ...
          {user && (
            <Link
              to=""
              className="bg-tertiary transition-colors hover:bg-secondary hover:text-white mt-5 rounded-md inline-flex items-center justify-center py-3 px-7 text-center text-xl font-semibold text-secondary">
              Hitung Kalorimu {">>"}
            </Link>
          )}
        </div>
